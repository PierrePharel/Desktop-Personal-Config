...
#region Autogenerated code
	...
	public class ClassGroup : GLib.Object {
		...
		public ClassGroup(IntPtr raw) : base(raw) {}

		protected ClassGroup() : base(IntPtr.Zero)
		{
		...
		{
			try {
				ClassGroup app_managed = GLib.Object.GetObject (app, false) as ClassGroup;
		...
		[GLib.DefaultSignalHandler(Type=typeof(Wnck.ClassGroup), ConnectionMethod="OverrideIconChanged")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(Wnck.ClassGroup), ConnectionMethod="OverrideNameChanged")]
		...
		public Gdk.Pixbuf Icon { 
			get {
				IntPtr raw_ret = wnck_class_group_get_icon(Handle);
		...
		[DllImport("wnck-1", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr wnck_class_group_get_windows(IntPtr raw);

		public Wnck.Window[] Windows { 
			get {
				IntPtr raw_ret = wnck_class_group_get_windows(Handle);
		...
		[DllImport("wnck-1", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr wnck_class_group_get_type();

		static GLib.GType _gtype = new GLib.GType (wnck_class_group_get_type());
		...
		[DllImport("wnck-1", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr wnck_class_group_get_mini_icon(IntPtr raw);

		public Gdk.Pixbuf MiniIcon { 
			get {
				IntPtr raw_ret = wnck_class_group_get_mini_icon(Handle);
				Gdk.Pixbuf ret = GLib.Object.GetObject(raw_ret) as Gdk.Pixbuf;
				return ret;
			}
		}
		...
		public string Name { 
			get {
				IntPtr raw_ret = wnck_class_group_get_name(Handle);
		...
		[DllImport("wnck-1", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr wnck_class_group_get(IntPtr res_class);
		...
		public string ResClass { 
			get {
				IntPtr raw_ret = wnck_class_group_get_res_class(Handle);
				string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
				return ret;
			}
		}
	...
	internal class ClassGroupAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("wnck-1", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr wnck_class_group_get_type ();

		private static GLib.GType _gtype = new GLib.GType (wnck_class_group_get_type ());
